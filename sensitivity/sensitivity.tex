...
\begin{itemize}
    ...
    \item Explore and test the \texttt{directsampling.oms} available at
    \url{} %TODO tp download url - in chat ?
...
$\rightarrow$ \textbf{Practice: } explore the script \texttt{saltelli.oms}
...
\begin{itemize}
	\item Direct sampling can be useful both as preliminary experiments and 
\end{itemize}
